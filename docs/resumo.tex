...
\begin{equation}
    \text{Decida } \omega_i \text{ para } \max_i P(\omega_i).
    \label{eq:decision_1}
\end{equation}
...
\begin{equation}
    \text{Decida } \omega_i \text{ para } \max_i P(\omega_i|x),
    \label{eq:decision_3}
\end{equation}
...
\subsection{Classificadores, Funções Discriminantes e Superfícies de Decisão}
